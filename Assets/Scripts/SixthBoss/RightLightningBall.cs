...
public class RightLightningBall : MonoBehaviour {
    Animator animator;
    ...
    void Update()
    {
        transform.position = GameObject.Find("SixthBoss").transform.position + new Vector3(6.0f, -5.32f, 0f);
        if (SixthBossScript.whichBall == 2)
        {

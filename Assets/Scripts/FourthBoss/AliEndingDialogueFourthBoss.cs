...
public class AliEndingDialogueFourthBoss : MonoBehaviour {
    SpriteRenderer rend;
    AudioSource audio;
    public Sprite ali1, ali2, ali3, ali4, ali5;
    Sprite[] aliExpressions;
    public GameObject script1, script2, script3, script4, script5;
    GameObject[] aliLines;
    int aliPhase = 0;
    ...
    void Start()
    {
        ...
        aliExpressions = new Sprite[] { ali1, ali2, ali3, ali4, ali5 };
        aliLines = new GameObject[] { script1, script2, script3, script4, script5 };
    ...
    void Update()
    {
        ...
        else
        {
            ...
            {
                FadeInOutFourthBoss.fadeOut = true;

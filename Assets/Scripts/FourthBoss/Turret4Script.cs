...
public class Turret4Script : MonoBehaviour {
    ...
    void Update()
    {
        ...
        {
            transform.position = GameObject.Find("FourthBoss").transform.position + new Vector3(1.45f, -0.1f, 0f);
            ...
            if (FourthBossScript.fireTurret == true && FourthBossScript.whatTurretFire == 4)
            {

...
public class Turret2Script : MonoBehaviour {
    ...
    void Update()
    {
        ...
        {
            transform.position = GameObject.Find("FourthBoss").transform.position + new Vector3(-.9f, -.1f, 0f);
            ...
            if (FourthBossScript.fireTurret == true && FourthBossScript.whatTurretFire == 2)
            {

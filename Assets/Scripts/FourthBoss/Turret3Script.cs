...
public class Turret3Script : MonoBehaviour {
    ...
    void Update()
    {
        ...
        {
            transform.position = GameObject.Find("FourthBoss").transform.position + new Vector3(.3f, -0.1f, 0f);
            ...
            if (FourthBossScript.fireTurret == true && FourthBossScript.whatTurretFire == 3)
            {
